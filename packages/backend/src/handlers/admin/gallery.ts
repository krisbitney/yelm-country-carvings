...
// Path to the gallery data file
const GALLERY_FILE_PATH = path.join(import.meta.dir, '../../../data/gallery.json');
const IMAGES_DIR = path.join(import.meta.dir, '../../../img/gallery');
